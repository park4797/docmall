...
CREATE TABLE MBSP_TBL(
        ...
        MBSP_POINT          NUMBER DEFAULT 0        NOT NULL,       -- 포인트
        MBSP_LASTLOGIN      DATE DEFAULT SYSDATE    NOT NULL,       -- 최근 접속일
        MBSP_DATESUB        DATE DEFAULT SYSDATE    NOT NULL,       -- 등록일
        MBSP_UPDATEDATE     DATE DEFAULT SYSDATE    NOT NULL        -- 정보 수정일
);
